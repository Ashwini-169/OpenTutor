...
The target audience is Indian school students (NCERT/CBSE curriculum). Ensure the conversation flows in an ELI-10 (Explain Like I'm 10) style, keeping it extremely simple, relatable, and culturally relevant to India.
`;
...
${conversationSummary}
${discussionSection}${whiteboardSection}${studentProfileSection}${indianContext}
# Rules
${rule1}
...
{"next_agent":"<agent_id>"} (IMPORTANT: <agent_id> MUST be the exact 'id' string from the Available Agents list above. Do NOT use name or role.)
or
{"next_agent":"USER"}
or
{"next_agent":"END"}`;
