...
export const PROVIDERS: Record<ProviderId, ProviderConfig> = {
  ...
  ollama: {
    ...
    models: [
      ...
      {
        id: 'kavai/qwen3.5-Gemini-Design:2b',
        name: 'kavai/qwen3.5-Gemini-Design:2b',
        capabilities: { streaming: true, tools: false, vision: false },
      },
      {
        id: 'qwen3.5:2b',
      ...
      {
        id: 'hf.co/Jackrong/Qwen3.5-4B-Claude-4.6-Opus-Reasoning-Distilled-v2-GGUF:Q4_K_M',
        name: 'hf.co/Jackrong/Qwen3.5-4B-Claude-4.6-Opus-Reasoning-Distilled-v2-GGUF:Q4_K_M',
        capabilities: { streaming: true, tools: false, vision: false },
      },
      {
        id: 'kavai/qwen3.5-GPT5:2b',
        name: 'kavai/qwen3.5-GPT5:2b',
        capabilities: { streaming: true, tools: false, vision: false },
      },
    ],
  },
...
export function getModel(config: ModelConfig): ModelWithInfo {
  ...
  // Ollama is local/self-hosted and should never be blocked on API key checks,
  // even if a stale header/config accidentally marks it as key-required.
