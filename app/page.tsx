    ...
    <div className="min-h-[100dvh] w-full bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex flex-col items-center p-4 pt-16 md:p-8 md:pt-16 overflow-x-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="mb-3 md:-ml-3 flex items-center gap-2.5"
        >
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white">
            Open<span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-sky-500">Tutor</span>
          </h1>
        </motion.div>
        ...
        >
          <p className="text-sm font-medium text-indigo-600/90 dark:text-indigo-400/90 mb-1.5 flex items-center gap-1.5 px-3 py-1 bg-indigo-50 dark:bg-indigo-900/20 rounded-full border border-indigo-100 dark:border-indigo-800/30">
            <span>🇮🇳</span> Step-by-step AI tutoring for Indian students
          </p>
        ...
        <motion.div
          ...
          className="flex flex-wrap justify-center gap-2 mb-6 max-w-lg"
        >
          {[
            { label: 'Class 10 Math', prompt: 'Class 10 Maths: Triangles chapter step-by-step sikhao' },
            { label: 'Science', prompt: 'CBSE Science: How does photosynthesis work? Whiteboard pe draw karo' },
            { label: 'English Grammar', prompt: 'English Grammar rules explain karo with examples' },
            { label: 'History', prompt: 'Class 9 History: French Revolution detail mein batao' }
          ].map((subject) => (
            <button
              key={subject.label}
              onClick={() => updateForm('requirement', subject.prompt)}
              className="px-3 py-1.5 text-xs font-medium bg-white/50 dark:bg-slate-800/50 hover:bg-indigo-50 dark:hover:bg-indigo-900/40 text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-300 rounded-full border border-slate-200/60 dark:border-slate-700/60 transition-colors"
            >
              {subject.label}
            </button>
          ))}
      ...
      <div className="mt-auto pt-12 pb-4 text-center text-xs text-muted-foreground/40 font-medium">
        OpenTutor AI — Bharat ka AI Tutor 🇮🇳
      </div>
    </div>
  );
}
