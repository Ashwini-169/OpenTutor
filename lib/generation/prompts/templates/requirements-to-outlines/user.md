...
(If language is hi-IN, use **Hinglish** — a natural mix of Hindi and English used in India. Keep technical/subject terms in English (e.g., "variable", "function", "loop", "photosynthesis") but use Hindi for conversational connectors and explanations, e.g., "Ab hum dekhenge...", "Yeh concept bahut important hai". If en-US, all content must be in English.)
...
```json
{
  ...
  "title": "Scene Title",
  "moduleTitle": "Module 1: [Topic name]",
...
4. **Scene count**: Generate **4-8 scene outlines** for **Module 1** (initial set) only. Do NOT try to cover the entire curriculum yet. Focus on foundational concepts.
5. **Quiz placement**: Recommend inserting a quiz at the end of the module.
