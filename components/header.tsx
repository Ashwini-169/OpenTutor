        ...
        <div className="flex items-center gap-4 bg-white/60 dark:bg-gray-800/60 backdrop-blur-md px-2 py-1.5 rounded-full border border-gray-100/50 dark:border-gray-700/50 shadow-sm shrink-0">
          ...
          <div className="relative">
            <button
              ...
              title={t('common.debugPanel') || 'Debug Panel'}
              className={cn(
                ...
                useDebugStore((s) => s.isOpen) && 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-500'
              )}
            >
              <Activity className="w-4 h-4 transition-transform duration-500" />
            </button>
          </div>
